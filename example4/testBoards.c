...
void testBoards() {
  ...
  tictactoe_board_t board6, board7, board8, board9, board10, board11, board12,
      board13, board14, board15;
  ...
  board6.squares[BOT][LFT] = MINIMAX_O_SQUARE;
  board6.squares[BOT][MID] = MINIMAX_X_SQUARE;
  board6.squares[BOT][RGT] = MINIMAX_X_SQUARE;
  ...
  board12.squares[TOP][MID] = MINIMAX_X_SQUARE;
  ...
  board13.squares[BOT][LFT] = MINIMAX_EMPTY_SQUARE;
